...
const navigate = useNavigate()
  ...
  return (
    ...
    <div onClick={() => {navigate(`/car-details/${car._id}`); window.scrollTo({ top: 0, behavior: 'smooth'});}}
     className='relative group rounded-xl overflow-hidden shadow-lg hover:-translate-y-3
      transition-all duration-500 cursor-pointer'>
        ...
        <div className='relative h-45 overflow-hidden'>
            ...
            <div className='absolute bottom-4 right-4 bg-black/80 backdrop-blur-sm
                ...
                <span className=''>{currency} {car.pricePerDay}</span>
