...
const Testimonials = () => {
 ...
 const testimonials = [
        { 
         ...
         testimonial: "I've used many booking platforms before, but none compare to thepersonalized experience and attention to detail that CarRental provides."
        },
        { 
         name: "Liam Johnson", 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
                ...
                {testimonials.map((testimonial, index) => (
                    <motion.div 
                     ...
                     key={index} className="bg-white p-6 rounded-xl shadow-lg hover:-transition-y-1 transition-all duration-500 ">
