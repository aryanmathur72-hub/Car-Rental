  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      <button onClick={() => navigate(-1)} className='flex items-center 
        gap-2 mb-6 text-gray-500 cursor-pointer'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        {/* left side details */}
         <motion.div
          ...
          <motion.img 
             ...
             transition={{duration: 0.6,}}
             src={car.image} alt='car' className='w-full h-auto md:max-h-96
           ...
           <motion.div 
            ...
            >
             <div>
              ...
              <p className='text-gray-500 text-lg'> {car.year} . {car.category}</p>
             </div>
              ...
              <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-500'>The BMW X5 is a mid-size luxury 
                   SUV produced by BMW. The X5 made its 
        ...
        <motion.form 
         ...
         className='shadow-lg h-max sticky top-16 rounded-xl p-6 space-y-6 text-gray-500'>
           <p className='flex items-center justify-center text-2xl text-gray-800 font-semibold'>
