...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    {
      title: "confirmed ", value: data.completedBookings, icon: assets.calendar_icon_colored
    }
  ]
          ...
          {data.recentBookings.map((booking, index) =>(
            <div key={index} className='mt-4 flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                  <div className='hidden md:flex items-center justify-center w-12 h-1/2 rounded-full bg-primary/10'>
              ...
              <div className='flex items-center gap-2 font-medium'>
                <p className='text-sm to-gray-500'>{currency}{booking.price}</p>
